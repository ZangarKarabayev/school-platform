...
return [
    'school_year_date' => 'Тапсырыс күні таңдалған оқу жылына жатпайды.',
    'school_year' => 'Оқу жылы YYYY-YYYY форматында болуы керек, екінші жыл біріншіден бір жыл кейін болуы керек.',
