...
return [
    'school_year_date' => 'Дата заказа не относится к выбранному учебному году.',
    'school_year' => 'Учебный год должен иметь формат YYYY-YYYY, а второй год должен быть на единицу больше первого.',
