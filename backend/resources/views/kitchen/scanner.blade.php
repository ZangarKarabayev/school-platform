            ...
            <div class="kitchen-camera-wrap">
                ...
                @else
                    ...
                    <div class="kitchen-camera-actions" id="kitchen-camera-actions" data-mobile="false">
                        <button class="kitchen-camera-switch" id="kitchen-camera-switch" type="button">Сменить камеру</button>
                    </div>
                    <div class="kitchen-camera-frame">
                        ...
                        <div class="kitchen-camera-overlay" id="kitchen-camera-overlay">
                            <div class="kitchen-camera-message">
                                ...
                                <div class="kitchen-camera-hint" id="kitchen-camera-hint">Наведите камеру на QR ученика. Если доступ уже разрешен, камера включится автоматически.</div>
                            </div>
                        </div>
                    </div>
            ...
            document.addEventListener('DOMContentLoaded', () => {
                ...
                const startScanner = async () => {
                    if (typeof window.Html5Qrcode === 'undefined') {
                        showOverlay('Сканер QR не загрузился.', 'Проверьте интернет или доступ к CDN.');
                        return;
                    }
                ...
                const restartScannerWithFacingMode = async () => {
                    ...
                    showOverlay('Смена камеры...', 'Подождите, камера переподключается.');
